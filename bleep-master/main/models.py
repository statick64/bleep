...
class Lawyer(models.Model):
    ...
    firebase_key   = models.CharField( max_length = 150, blank = True, null = True)
    ...
    def create(self, username = "null", firstname = "null", lastname = "null", twitter_handle = "", email = "null@null.com", password = "00000000", address = "none supplied", phone = "0" ):
        ...
        lawyer = Lawyer.objects.create(user = user, firstname = firstname, lastname = lastname, twitter_handle = twitter_handle, email = email, address = address, phone = phone )
    ...
    def handle_beeep(civilian, request):
        ...
        if action == "start":
            ...
            try:
                ...
                response = requests.post(url,data=json.dumps(body),headers=newHeaders)
